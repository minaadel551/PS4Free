...
هذا المشروع هو صفحة ويب تقوم بعمل jailbreak تلقائي لجهاز PlayStation 4 بإصدار البرنامج الثابت 7.00 - 9.60 باستخدام استغلال PSFree و Lapse. يقوم المشروع بتحميل وتنفيذ GoldHEN v2.4b18.6 تلقائيًا دون الحاجة إلى فلاشة USB أو أي أجهزة خارجية.
...
🎯 دعم البرامج الثابتة: PS4 7.00 - 9.60 (معدل الاستقرار 99 ٪)
...
1. قم بفتح متصفح الإنترنت على جهاز PS4 بإصدار 7.00 - 9.60.
...
5. سيتم تحميل وتنفيذ GoldHEN تلقائيًا.
...
⦁	GoldHEN : الـ payload الرئيسي للـ jailbreak (بواسطة SiSTRo)
